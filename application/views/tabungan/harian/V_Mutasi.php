              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <label class="badge badge-danger" style="position: absolute; left: 125px;"><a class="text-danger" style="text-decoration: none;" href="<?= base_url('print_mutasi_harian/' . $siswa->nis) ?>">Print</a></label>
                    </div>
                    <div class="col-lg-3">
