              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    ...
                    <label class="badge badge-danger" style="position: absolute; left: 120px;"><a class="text-danger" style="text-decoration: none;" target="_blank" href="<?= base_url('print_tabungan_harian') ?>">Print</a></label>
                    <?php
