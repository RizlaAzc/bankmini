        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                <a href="<?= base_url('tabungan_tahunan') ?>" class="btn btn-outline-primary" style="float: right;">Kembali</a>
                  <h4 class="card-title">Mutasi Tabungan Tahunan (<?= $siswa->nama_siswa ?>)</h4>
                  <p class="card-description">Saldo saat ini : Rp<?= $saldo_saat_ini['saldo_tahunan'] ?>
                  <div class="row">
                    <div class="col-lg-9">
                    ...
                    <label class="badge badge-danger" style="position: absolute; left: 125px;"><a class="text-danger" style="text-decoration: none;" target="_blank" href="<?= base_url('print_mutasi_tahunan/' . $siswa->nis) ?>">Print</a></label>
                    </div>
                    <div class="col-lg-3">
                    ...
                    <table id="searchTable" class="table">
                      ...
                      <tbody>
                        ...
                        ?>
                            ...
                            <td>Rp<?= $transaksi->saldo_tahunan ?></td>
