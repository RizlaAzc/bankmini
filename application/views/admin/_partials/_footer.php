            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="id_petugas" value="<?= $profil['id_petugas'] ?>" readonly >
                        <input type="text" class="form-control" id="inputAddress" name="nisn" placeholder="12345" >
                    </div>
                    <div class="form-group">
                        <label for="inputAddress2" class="form-label">Tahun Dibayar</label>
                        <input type="text" class="form-control" id="exampleInputUsername1" name="tahun_dibayar" placeholder="1234">
                    </div>
                    <div class="form-group">
                        <label for="inputAddress2" class="form-label">Nominal</label>
                        <input type="text" class="form-control" id="exampleInputUsername1" name="jumlah_bayar" placeholder="1000000">
                    </div>
                  </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="<?= base_url('admin/C_Login/logout') ?>">Logout</a>
                </div>
            </div>
        </div>
    </div>
